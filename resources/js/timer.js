var yourDateToGo = new Date('August 07, 2021 07:00:00'); //here you're making new Date object
...
var timing = setInterval( // you're making an interval - a thing, that is updating content after number of miliseconds, that you're writing after comma as second parameter
  function() {
    ...
    document.getElementById("days").innerHTML = days; // putting number of days, hours, minutes and seconds in div,
    ...
    if (timeLeft <= 0) {
      ...
      document.getElementById("countdown").innerHTML = "It's time!"; //if there's no time left, programm in this 2 lines is clearing interval (nothing is counting now)
